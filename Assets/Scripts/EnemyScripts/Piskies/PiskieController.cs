...
public class PiskieController : MonoBehaviour,IDamageable, IEnemyType
{
    ...
    private void Update()
    {
        ...
        this.transform.position = new Vector3(this.transform.position.x, 0.5f, this.transform.position.z);//DONT LOOK AT THIS
